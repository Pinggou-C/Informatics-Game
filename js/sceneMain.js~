  ...
  preload(){
    this.load.spritesheet('fullscreen', 'images/ui/fullscreen.png', { frameWidth: 32, frameHeight: 32 });
    this.load.spritesheet('dude','images/player/dude.png',{ frameWidth: 32, frameHeight: 48 });
    this.load.image('back','images/1.png');
  }
